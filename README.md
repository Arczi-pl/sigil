...
```
$ python3 sigil.py --input examples/lorem_ipsum.txt --output examples/lorem_ipsum_output.txt --signature "created by Artur Sikorski"
```

and then:

```
$ python3 sigil_extractor.py --input examples/lorem_ipsum_output.txt
...
Learn from:
```
$ python3 learn.py --file examples/lorem_ipsum_output.txt
INVISIBLE_CHARS
